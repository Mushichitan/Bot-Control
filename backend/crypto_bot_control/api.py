            ...
            out.append(
                {
                    ...
                    "tp": r.tp,
                    "tps": services._parse_tps_json(r.tps_json),
                    "hit_tps": services._parse_tps_json(r.hit_tps_json),
                    "tp_hits": r.tp_hits or 0,
                    "tps_total": r.tps_total or len(services._parse_tps_json(r.tps_json)),
                    "booked_pnl": r.booked_pnl or 0.0,
                    "sl": r.sl,
